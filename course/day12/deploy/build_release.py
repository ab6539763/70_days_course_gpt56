"""构建并验证 NexusAI 0.0.12 HTTP API 平台发布包。"""
...
SOURCE = ROOT / "course/day12/solution"
FIXTURES = ROOT / "course/day12/fixtures/corpus"
NAME = "nexus-api-platform-0.0.12"
WHITELIST = {"main.py", "requirements.txt", "README.txt", "SHA256SUMS", "nexus", "corpus"}
parser = ArgumentParser()
parser.add_argument("--output", type=Path, default=ROOT / "artifacts/day12")
...
(stage / "README.txt").write_text(
    "智枢 NexusAI HTTP API 平台 0.0.12\nPython 3.10+\n"
    "依赖：pip install -r requirements.txt\n"
    "环境：export NEXUS_API_KEY=... （或 NEXUS_USE_MOCK=1 演示）\n"
