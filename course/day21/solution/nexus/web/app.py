...
def create_app(data_file=DATA_FILE, session_dir=None):
    ...
    app.config["SESSION_REGISTRY"] = SessionRegistry(session_dir=session_dir)
    app.config["STREAM_RESUME_STORE"] = StreamResumeStore()
