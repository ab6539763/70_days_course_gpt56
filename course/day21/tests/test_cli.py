...
with tempfile.TemporaryDirectory(prefix="nexus-day21-cli-") as temporary:
    ...
    try:
        for _ in range(30):
            try:
                req = Request(
                    "http://127.0.0.1:18086/api/revision",
...
server.shutdown()
print("Day 21 CLI/Web 验收通过：菜单21、乐观锁与 --web 均正确。")
