...
SOURCE = ROOT / "course/day11/solution"
...
parser.add_argument("--output", type=Path, default=ROOT / "artifacts/day11")
...
(stage / "README.txt").write_text(
    "智枢 NexusAI 语料平台 0.0.11\nPython 3.10+\n"
    "运行：PYTHONPATH=. python3 main.py\n"
    "示例语料在 corpus/ 目录，可用菜单 10 导入。\n",
    encoding="utf-8",
)
