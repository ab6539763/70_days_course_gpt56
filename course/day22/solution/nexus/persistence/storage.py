...
from nexus.observability.audit_log import record_audit_event
...
def persist_change(state, data_file=DATA_FILE, expected_revision=None, audit_event=None, audit_store=None):
    """持久化变更；可选 expected_revision 乐观锁与审计日志。"""
