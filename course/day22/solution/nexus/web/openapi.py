...
def build_openapi_spec(base_url="http://127.0.0.1:8080"):
    ...
    return {
        ...
        "info": {
            ...
            "version": APP_VERSION,
            "description": "Phase2 Web 对话工作台 REST 契约（Day22 审计日志）",
        },
        ...
        "paths": {
            ...
            "/api/revision": {
                "get": {
                    "summary": "获取当前会话 revision（乐观锁）",
                    "operationId": "getRevision",
                    "parameters": [{"$ref": "#/components/parameters/SessionHeader"}],
                    "responses": {
                        "200": {
                            "description": "revision 快照",
                            "content": {
                                "application/json": {
            ...
            "/api/audit": {
                "get": {
                    "summary": "查询当前会话 revision 变更审计日志",
            ...
            "/api/chat": {
                "post": {
                    "summary": "发送对话（乐观锁 expected_revision）",
                    "operationId": "postChat",
                    "parameters": [
                        {"$ref": "#/components/parameters/SessionHeader"},
                        {"$ref": "#/components/parameters/ExpectedRevisionHeader"},
                    ],
                    "requestBody": {
                        "required": True,
                        "content": {
        ...
        "components": {
            "parameters": {
                ...
                "ExpectedRevisionHeader": {
                    "name": "X-Expected-Revision",
                    "in": "header",
                    "required": False,
                    "schema": {"type": "integer", "minimum": 0},
                    "description": "乐观锁：客户端认为的当前 revision，写操作前与磁盘比对",
                },
            },
            "schemas": {
                "ApiError": {
                ...
                "ChatRequest": {
                    ...
                    "properties": {
                        ...
                        "expected_revision": {
                            "type": "integer",
                            "minimum": 0,
                            "description": "乐观锁：写前 revision 期望值",
                        },
                    },
                },
                "StreamChatRequest": {
            ...
            "responses": {
                ...
                "RevisionConflict": {
                    "description": "revision 乐观锁冲突",
                    "content": {
                        "application/json": {
                            "schema": {"$ref": "#/components/schemas/RevisionConflictResponse"}
                        }
                    },
                },
            },
