#!/usr/bin/env python3
"""生成 Day 21 课件，满足 verify_day21 字符与 Mermaid 门禁。"""

from pathlib import Path

OUT = Path(__file__).resolve().parents[1] / "course/day21/day21-lesson.md"
...
```mermaid
flowchart LR
    L01["L01 双标签冲突"] --> L03["L03 409 处理"]
    L03 --> L05["L05 chat.js 自动刷新"]
    L05 --> L10["L10 verify_day21"]
```
""",
    """
```mermaid
...
BODY = """# Day 21｜乐观锁、expected_revision 与 revision 冲突检测
